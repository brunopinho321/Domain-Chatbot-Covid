(define 
    ...
    (:predicates
        ...
        (have-diagnostic-system-positive)
        ...
        (can-show-info-calling-health-profitional)
        (can-finish-service)
        ...
        (can-do-show-info-diagnostic-negative)
        (can-do-show-info-diagnostic-positive)
    ...
    (:action call-diagnostic-system
        ...
        :precondition (and 
            ...
            (have-patient-symptoms)
            (can-call-diagnostic-system) 
            (not(have-diagnostic-system-positive))
            (not(can-go-error-treatment))
        )
        :effect (oneof 
            ...
            ;outcome patient-do-not-have-covid
            (and
                (send-info-diagnostic-system)
                (not (have-diagnostic-system-positive)) 
                (not (can-call-diagnostic-system))
    ...
    (:action show-info-diagnostic-positive
        :parameters ()
        :precondition (and 
            (have-diagnostic-system-positive)
            (can-do-show-info-diagnostic-positive)
        ...
        :effect (oneof
            ;outcome -
            (and
                (not (can-do-show-info-diagnostic-positive))
                (can-do-ask-share-location)
            )
        )
    )
    
    (:action show-info-diagnostic-negative
        :parameters ()
        :precondition (and 
            (can-do-show-info-diagnostic-negative)
            (not (can-go-error-treatment))
        ...
        :effect (oneof
            ;outcome -
            (and
                (not (can-do-show-info-diagnostic-negative))
                (can-show-ask-user-grade)
            )
    ...
    (:action show-info-calling-health-profitional
        :parameters ()
        :precondition (and 
            (can-show-info-calling-health-profitional)
        )
        :effect (oneof
            ;outcome -
            (and
                (not(can-show-info-calling-health-profitional))
                (can-do-ask-patient-info-cpf)
            )
        )
    )
    ...
    (:action ask-patient-info-name
        ...
        :effect (oneof 
            ...
            (and 
                (send-info-name)
                (have-patient-name)
                (not (can-do-ask-patient-info-name))
                (can-do-ask-patient-info-birthday)
            )
            ;outcome Error 
            (and 
    ...
    (:action ask-patient-info-birthday
        ...
        :effect (oneof 
            ...
            (and 
                (have-patient-birthday)
                (not (can-do-ask-patient-info-birthday))
                (send-info-birthday)
                (can-do-ask-patient-comorbidities)
            )
            ;outcome Error
    ...
    (:action ask-patient-info-gender
        ...
        :effect (oneof 
            ...
            ;outcome not-have-gender-declareted
            (and
                (send-info-gender)
                (not(have-patient-gender-f))
                (not(have-patient-gender))
